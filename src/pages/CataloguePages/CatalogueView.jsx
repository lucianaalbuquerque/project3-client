...
function CatalogueView() {
  ...
  const getCatalogue = () => {
    axios
      .get(`${process.env.REACT_APP_API_URL}/catalogue/${catalogueId}`, {
        ...
        <div className="catalogueView">
          ...
          <div className="previewCatalogue">
            ...
            <div className="previewPage">
              {catalogue.report && (
                <>
                  <Link to={`/${catalogueId}/report/${catalogue.report._id}`}>
                    Products Summary
                  </Link>
                </>
              )}
              {!catalogue.report && (
                <CreateReportBtn catalogueId={catalogue._id} products={productList} />
              )}
            </div>
          </div>
